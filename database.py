...
MESSAGES_COLLECTION_NAME_DEV = "msgdev"
MESSAGES_COLLECTION_NAME_PROD = "messages"
MESSAGES_COLLECTION_NAME = MESSAGES_COLLECTION_NAME_PROD if env.get_env_variables()['ENV'] == 'PROD' else MESSAGES_COLLECTION_NAME_DEV
